...
ingredients_wo_allergens = set()
for i in ingredients_set:
    if i not in final_dict:
        ingredients_wo_allergens.add(i)
# print(len(ingredients_wo_allergens))
        
# print(ingredients_wo_allergens)
answer = 0
for i in ingredients_wo_allergens:
    answer+= all_ingredients_list.count(i)
